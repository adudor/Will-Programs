...
public class CarrotPatchTester extends CarrotPatch {
  ...
  public static boolean test2isCloseMethod() {
    ...
    try {
      ...
      if (w1.isClose(w2, Wolf.getScanRange())) { // bug! isClose() should return false here
        System.out
            .println("Problem detected: Wolf.isClose() returned true when it should return false.");
        return false;
      }
  ...
  public static boolean test3isCloseMethod() {
    ...
    try {
      ...
      r.setX(200);
      r.setY(200);
      if (r.isClose(376, 200, r.getScanRange())) { // bug! isClose() should return false here
        System.out.println(
            "Problem detected: Rabbit.isClose() returned true when it should return false.");
        return false;
      }
