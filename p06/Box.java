...
public class Box {
    ...
    /**
     * Creates a new Box and initializes its instance fields color and unique
     * inventory number
     * 
     * @param color color to be assigned of this box. It can be any of the constant
     *              color values defined in the enum Color: Color.BLUE, Color.BROWN,
     *              or Color.YELLOW
     */
    ...
    /**
     * Returns a String representation of this box in the format "color
     * INVENTORY_NUMBER"
     *
    ...
    /**
     * This method sets the nextInventoryNumber to 1. This method must be used in
     * your tester methods only.
     */
